#!/usr/bin/env bash
# install.sh — fetch the docker-compose.yml from the ubersdr_dxcluster repo and start the service
#
...
REPO_RAW="https://raw.githubusercontent.com/madpsy/ubersdr_dxcluster/main"
...
DATA_DIR="dxcluster_data"
mkdir -p "${INSTALL_DIR}/${DATA_DIR}"
# Make writable by the container's dxcluster user (uid 999)
...
echo ""
echo "Done. ubersdr_dxcluster is running."
...
echo "    Rate Limit   : 100"
echo ""
echo "  Then access the web UI at: http://your-ubersdr-host/addon/dxcluster/"
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
